...
function performSearch(searchTerm) {
    ...
    categories.forEach(category => {
        ...
        const searchPromise = new Promise((resolve, reject) => {
            ...
            xhr.open('GET', `books/${categoryId}/`, true);
                        ...
                        const folderPromises = folders.map(folder => {
                            return new Promise((folderResolve, folderReject) => {
                                ...
                                try {
                                    ...
                                    infoXhr.open('GET', `${folderPath}/Information`, true);
        ...
        if (results.length === 0) {
            ...
            results.forEach(book => {
                ...
                bookCard.innerHTML = `
                    ...
                    <a href="${book.folderPath}/1.html" class="read-more">阅读更多</a>
                `;
                ...
                if (xhr.status === 200) {
                    ...
                    const folderPromises = Array.from(folders).map(folder => {
                        return new Promise((resolve, reject) => {
                            const folderName = folder.innerText.replace('/', '');
                            const folderPath = `books/${currentCategoryId}/${folderName}`;
